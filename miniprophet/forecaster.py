...
try:
    import prophet.make_holidays.get_holiday_names
except ImportError:
    pass

try:
    import prophet.make_holidays.make_holidays_df
except ImportError:
    pass

try:
    import prophet.plot.plot
except ImportError:
    pass

try:
    import prophet.plot.plot_components
except ImportError:
    pass
...
class Prophet(object):
    ...
    def fit(self, df, **kwargs):
        ...
        if history['y'].min() == history['y'].max() and \
            ...
            self.params = m2.maximize_loglik(params_init, dat,**kwargs) 
